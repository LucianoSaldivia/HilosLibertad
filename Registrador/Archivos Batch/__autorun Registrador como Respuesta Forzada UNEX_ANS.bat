...
@REM Sin consola
@REM start D:/Programas/Python/pythonw.exe "%~dp0/../Registrador.py" "-respuesta_forzada" "unex_ans"

@REM Con consola (para monitorear)
start D:/Programas/Python/python.exe "%~dp0/../Registrador.py" "-respuesta_forzada" "unex_ans"