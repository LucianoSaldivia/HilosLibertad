...
start "%python_path%" "%~dp0/../Registrador.py" "-registrador" "-print_all"
...
@REM start "%pythonw_path%" "%~dp0/../Registrador.py" "-registrador" "-print_all"

@REM start D:/Programas/Python/python.exe "%~dp0/../Registrador.py" "-registrador" "-print_all"
