        ...
        while 1:
            ...
            if len(trama) >= defines.BUFFER_SIZE_ONLY_DATA_MODE:
                ...
                if check == True:
                    ...
                    showAllDataForcedAnswer( trama, contador_tramas, contador_naks, curr_dt, last_dt )
